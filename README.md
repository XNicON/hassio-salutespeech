...
Компонент позволяющий использую SaluteSpeech API генерировать голос для собственных нужд.
Пока бесплатно доступно 200 000 символов для физ. лиц.
Мне для того чтобы проговорил с утра погоду и разную инфу с датчиков, достаточно, всё приятнее гуг-транслейта произношение.
